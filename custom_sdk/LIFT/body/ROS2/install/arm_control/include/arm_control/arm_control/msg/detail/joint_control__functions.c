...
arm_control__msg__JointControl__create(void)
{
...
arm_control__msg__JointControl__Sequence__init(arm_control__msg__JointControl__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(arm_control__msg__JointControl)) {
      return false;
    }
  ...
  arm_control__msg__JointControl__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(arm_control__msg__JointControl)) {
      return false;
    }
